...
}, bo = Kt ? (r) => r : (r) => r instanceof CSSStyleSheet ? ((e) => {
  let t = "";
  for (const o of e.cssRules) t += o.cssText;
  return _i(t);
})(r) : r;
const { is: Ci, defineProperty: $i, getOwnPropertyDescriptor: Si, getOwnPropertyNames: Ei, getOwnPropertySymbols: zi, getPrototypeOf: Ai } = Object, Je = globalThis, go = Je.trustedTypes, Ti = go ? go.emptyScript : "", Ii = Je.reactiveElementPolyfillSupport, ke = (r, e) => r, Xe = { toAttribute(r, e) {
  switch (e) {
    case Boolean:
      r = r ? Ti : null;
      break;
...
const Zt = globalThis, xo = (r) => r, Ze = Zt.trustedTypes, wo = Ze ? Ze.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, Vo = "$lit$", ie = `lit$${Math.random().toFixed(9).slice(2)}$`, Uo = "?" + ie, Pi = `<${Uo}>`, ce = document, $e = () => ce.createComment(""), Se = (r) => r === null || typeof r != "object" && typeof r != "function", Qt = Array.isArray, Mi = (r) => Qt(r) || typeof r?.[Symbol.iterator] == "function", at = `[ 	
\f\r]`, we = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, _o = /-->/g, ko = />/g, le = RegExp(`>|${at}(?:([^\\s"'>=/]+)(${at}*=${at}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Co = /'/g, $o = /"/g, qo = /^(?:script|style|textarea|title)$/i, Li = (r) => (e, ...t) => ({ _$litType$: r, strings: e, values: t }), l = Li(1), q = /* @__PURE__ */ Symbol.for("lit-noChange"), h = /* @__PURE__ */ Symbol.for("lit-nothing"), So = /* @__PURE__ */ new WeakMap(), de = ce.createTreeWalker(ce, 129);
function Ho(r, e) {
...
const Bi = (r, e) => {
  ...
  let i, a = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", n = we;
  for (let c = 0; c < t; c++) {
    const p = r[c];
    let b, u, v = -1, g = 0;
    for (; g < p.length && (n.lastIndex = g, u = n.exec(p), u !== null); ) g = n.lastIndex, n === we ? u[1] === "!--" ? n = _o : u[1] !== void 0 ? n = ko : u[2] !== void 0 ? (qo.test(u[2]) && (i = RegExp("</" + u[2], "g")), n = le) : u[3] !== void 0 && (n = le) : n === le ? u[0] === ">" ? (n = i ?? we, v = -1) : u[1] === void 0 ? v = -2 : (v = n.lastIndex - u[2].length, b = u[1], n = u[3] === void 0 ? le : u[3] === '"' ? $o : Co) : n === $o || n === Co ? n = le : n === _o || n === ko ? n = we : (n = le, i = void 0);
    const y = n === le && r[c + 1].startsWith("/>") ? " " : "";
    a += n === we ? p + Pi : v >= 0 ? (o.push(b), p.slice(0, v) + Vo + p.slice(v) + ie + y) : p + ie + (v === -2 ? c : y);
  }
...
class Ee {
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    this.parts = [];
    let a = 0, n = 0;
    const c = e.length - 1, p = this.parts, [b, u] = Bi(e, t);
    if (this.el = Ee.createElement(b, o), de.currentNode = this.el.content, t === 2 || t === 3) {
    ...
    for (; (i = de.nextNode()) !== null && p.length < c; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const v of i.getAttributeNames()) if (v.endsWith(Vo)) {
          const g = u[n++], y = i.getAttribute(v).split(ie), w = /([.?@])?(.*)/.exec(g);
          p.push({ type: 1, index: a, name: w[2], strings: y, ctor: w[1] === "." ? Vi : w[1] === "?" ? Ui : w[1] === "@" ? qi : tt }), i.removeAttribute(v);
        } else v.startsWith(ie) && (p.push({ type: 6, index: a }), i.removeAttribute(v));
        if (qo.test(i.tagName)) {
          const v = i.textContent.split(ie), g = v.length - 1;
          if (g > 0) {
            i.textContent = Ze ? Ze.emptyScript : "";
            for (let y = 0; y < g; y++) i.append(v[y], $e()), de.nextNode(), p.push({ type: 2, index: ++a });
            i.append(v[g], $e());
          }
        }
...
function be(r, e, t = r, o) {
  ...
  return i?.constructor !== a && (i?._$AO?.(!1), a === void 0 ? i = void 0 : (i = new a(r), i._$AT(r, t, o)), o !== void 0 ? (t._$Co ??= [])[o] = i : t._$Cl = i), i !== void 0 && (e = be(r, i._$AS(r, e.values), i, o)), e;
}
class Ni {
  constructor(e, t) {
  ...
  u(e) {
    ...
    for (; p !== void 0; ) {
      if (n === p.index) {
        let b;
        p.type === 2 ? b = new Te(a, a.nextSibling, this, e) : p.type === 1 ? b = new p.ctor(a, p.name, p.strings, this, e) : p.type === 6 && (b = new Hi(a, this, e)), this._$AV.push(b), p = o[++c];
      }
...
class Te {
  ...
  _$AI(e, t = this) {
    e = be(this, e, t), Se(e) ? e === h || e == null || e === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : e !== this._$AH && e !== q && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Mi(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== h && Se(this._$AH) ? this._$AA.nextSibling.data = e : this.T(ce.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    ...
    if (this._$AH?._$AD === i) this._$AH.p(t);
      ...
      const a = new Ni(i, this), n = a.u(this.options);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let o, i = 0;
    for (const a of e) i === t.length ? t.push(o = new Te(this.O($e()), this.O($e()), this, this.options)) : o = t[i], o._$AI(a), i++;
...
class tt {
  ...
  _$AI(e, t = this, o, i) {
    ...
    let n = !1;
    if (a === void 0) e = be(this, e, t, 0), n = !Se(e) || e !== this._$AH && e !== q, n && (this._$AH = e);
    else {
      const c = e;
      let p, b;
      for (e = a[0], p = 0; p < a.length - 1; p++) b = be(this, c[o + p], t, p), b === q && (b = this._$AH[p]), n ||= !Se(b) || b !== this._$AH[p], b === h ? e = h : e !== h && (e += (b ?? "") + a[p + 1]), this._$AH[p] = b;
    }
    n && !i && this.j(e);
  }
  j(e) {
...
Wi?.(Ee, Te), (Zt.litHtmlVersions ??= []).push("3.3.2");
const Jt = (r, e, t) => {
  const o = t?.renderBefore ?? e;
  let i = o._$litPart$;
  if (i === void 0) {
    const a = t?.renderBefore ?? null;
    o._$litPart$ = i = new Te(e.insertBefore($e(), a), a, void 0, t ?? {});
  }
  return i._$AI(r), i;
};
const eo = globalThis;
...
class Ie extends f {
  ...
  determineRippleSize() {
    const { height: e, width: t } = this.getBoundingClientRect(), o = Math.max(e, t), i = Math.max(or * o, tr), a = this.currentCSSZoom ?? 1, n = Math.floor(o * Ji / a), p = Math.sqrt(t ** 2 + e ** 2) + er;
    this.initialSize = n;
    const b = (p + i) / n;
    this.rippleScale = `${b / a}`, this.rippleSize = `${n}px`;
  }
  getNormalizedPointerEventCoords(e) {
    const { scrollX: t, scrollY: o } = window, { left: i, top: a } = this.getBoundingClientRect(), n = t + i, c = o + a, { pageX: p, pageY: b } = e, u = this.currentCSSZoom ?? 1;
    return {
      x: (p - n) / u,
      y: (b - c) / u
    };
...
function Q(r) {
  ...
  class t extends r {
    ...
    attributeChangedCallback(i, a, n) {
      ...
      const c = vt(i);
      n === null ? delete this.dataset[c] : this.dataset[c] = n, this.requestUpdate(vt(i), a);
    }
    getAttribute(i) {
...
function ro(r) {
  ...
  class t extends r {
    ...
    [(e = Me, Z)]() {
      ...
      const { validity: i, validationMessage: a } = this[lt].getValidity(), n = !!this[Me], c = this[Me] || a;
...
const fe = /* @__PURE__ */ Symbol("getFormValue"), bt = /* @__PURE__ */ Symbol("getFormState");
function ao(r) {
  class e extends r {
    get form() {
      return this[N].form;
    ...
    requestUpdate(o, i, a) {
      super.requestUpdate(o, i, a), this[N].setFormValue(this[fe](), this[bt]());
    }
    [fe]() {
...
s([
  k(".button")
], R.prototype, "buttonElement", void 0);
s([
  Y({ slot: "icon", flatten: !0 })
], R.prototype, "assignedIcons", void 0);
class wr extends R {
...
})(o) + r[i + 1], r[0]), r: ei }), To = /* @__PURE__ */ new Map(), Ar = (r) => (e, ...t) => {
  const o = t.length;
  let i, a;
  const n = [], c = [];
  let p, b = 0, u = !1;
  for (; b < o; ) {
    for (p = e[b]; b < o && (a = t[b], (i = zr(a)) !== void 0); ) p += i + e[++b], u = !0;
    b !== o && c.push(a), n.push(p), b++;
  }
  if (b === o && n.push(e[o]), u) {
    const v = n.join("$$lit$$");
    (e = To.get(v)) === void 0 && (n.raw = n, To.set(v, e = n)), t = c;
  }
  return r(e, ...t);
}, lo = Ar(l);
function Io(r, e = !0) {
...
class L extends Tr {
  ...
  render() {
    const e = this.href ? re`div` : re`button`, { ariaLabel: t, ariaHasPopup: o, ariaExpanded: i } = this, a = t && this.ariaLabelSelected, n = this.toggle ? this.selected : h;
    let c = h;
...
class z extends f {
  ...
  getLabelKeyframes() {
    ...
    if (!e || !t)
      return [];
    const { x: o, y: i, height: a } = e.getBoundingClientRect(), { x: n, y: c, height: p } = t.getBoundingClientRect(), b = e.scrollWidth, u = t.scrollWidth, v = u / b, g = n - o, y = c - i + Math.round((p - a * v) / 2), w = `translateX(${g}px) translateY(${y}px) scale(${v})`, C = "translateX(0) translateY(0) scale(1)", E = t.clientWidth, $ = u > E ? `${E / v}px` : "";
...
const Do = oo(class extends io {
  constructor(r) {
    ...
    if (!Pr(r)) throw Error("`live` bindings can only contain a single expression");
  }
  render(r) {
    return r;
  }
...
const oi = "important", Br = " !" + oi, ge = oo(class extends io {
  constructor(r) {
...
class Jr {
  constructor(e) {
    this.handleKeydown = (u) => {
      ...
      if (!g.length)
        return;
      const y = Ce(g, this.isActivatable);
      u.preventDefault();
      const w = this.isRtl(), C = w ? M.ArrowRight : M.ArrowLeft, E = w ? M.ArrowLeft : M.ArrowRight;
      let D = null;
      switch (v) {
        // Activate the next item
        case M.ArrowDown:
        case E:
          D = Oo(g, y, this.isActivatable, this.wrapNavigation());
          break;
        // Activate the previous item
        case M.ArrowUp:
        case C:
          D = Fo(g, y, this.isActivatable, this.wrapNavigation());
          break;
        // Activate the first item
        case M.Home:
          D = ai(g, this.isActivatable);
          break;
        // Activate the last item
        case M.End:
          D = si(g, this.isActivatable);
          break;
      }
      D && y && y.item !== D && (y.item.tabIndex = -1);
      ...
      if (v)
        return;
      const g = co(u, this.isActivatable);
      g && (g.tabIndex = 0);
    };
    const { isItem: t, getPossibleItems: o, isRtl: i, deactivateItem: a, activateItem: n, isNavigableKey: c, isActivatable: p, wrapNavigation: b } = e;
    this.isItem = t, this.getPossibleItems = o, this.isRtl = i, this.deactivateItem = a, this.activateItem = n, this.isNavigableKey = c, this.isActivatable = p, this.wrapNavigation = b ?? (() => !0);
  }
  /**
...
class ia {
   ...
   */
  async position() {
    const { surfaceEl: e, anchorEl: t, anchorCorner: o, surfaceCorner: i, positioning: a, xOffset: n, yOffset: c, disableBlockFlip: p, disableInlineFlip: b, repositionStrategy: u } = this.getProperties(), v = o.toLowerCase().trim(), g = i.toLowerCase().trim();
    if (!e || !t)
      return;
    const y = window.innerWidth, w = window.innerHeight, C = document.createElement("div");
    C.style.opacity = "0", C.style.position = "fixed", C.style.display = "block", C.style.inset = "0", document.body.appendChild(C);
    const E = C.getBoundingClientRect();
    C.remove();
    const D = window.innerHeight - E.bottom, $ = window.innerWidth - E.right;
    this.surfaceStylesInternal = {
      display: "block",
      opacity: "0"
    }, this.host.requestUpdate(), await this.host.updateComplete, e.popover && e.isConnected && e.showPopover();
    const F = e.getSurfacePositionClientRect ? e.getSurfacePositionClientRect() : e.getBoundingClientRect(), P = t.getSurfacePositionClientRect ? t.getSurfacePositionClientRect() : t.getBoundingClientRect(), [O, ee] = g.split("-"), [te, ne] = v.split("-"), Fe = getComputedStyle(e).direction === "ltr";
    ...
    let { inlineInset: Re, inlineOutOfBoundsCorrection: me, surfaceInlineProperty: vo } = this.calculateInline({
      surfaceRect: F,
      anchorRect: P,
      anchorInline: ne,
      surfaceInline: ee,
    ...
    if (me && !b) {
      ...
      Math.abs(me) > Math.abs(X.inlineOutOfBoundsCorrection) && (Re = X.inlineInset, me = X.inlineOutOfBoundsCorrection, vo = X.surfaceInlineProperty);
    }
    u === "move" && (ue = ue - G, Re = Re - me), this.surfaceStylesInternal = {
      display: "block",
      opacity: "1",
      [mo]: `${ue}px`,
      [vo]: `${Re}px`
    }, u === "resize" && (G && (this.surfaceStylesInternal.height = `${F.height - G}px`), me && (this.surfaceStylesInternal.width = `${F.width - me}px`)), this.host.requestUpdate();
  }
  /**
   ...
   */
  calculateBlock(e) {
    const { surfaceRect: t, anchorRect: o, anchorBlock: i, surfaceBlock: a, yOffset: n, positioning: c, windowInnerHeight: p, blockScrollbarHeight: b } = e, u = c === "fixed" || c === "document" ? 1 : 0, v = c === "document" ? 1 : 0, g = a === "start" ? 1 : 0, y = a === "end" ? 1 : 0, C = (i !== a ? 1 : 0) * o.height + n, E = g * o.top + y * (p - o.bottom - b), D = g * window.scrollY - y * window.scrollY, $ = Math.abs(Math.min(0, p - E - C - t.height));
    return { blockInset: u * E + v * D + C, blockOutOfBoundsCorrection: $, surfaceBlockProperty: a === "start" ? "inset-block-start" : "inset-block-end" };
  }
  /**
   * Calculates the css property, the inset, and the out of bounds correction
   ...
   */
  calculateInline(e) {
    const { isLTR: t, surfaceInline: o, anchorInline: i, anchorRect: a, surfaceRect: n, xOffset: c, positioning: p, windowInnerWidth: b, inlineScrollbarWidth: u } = e, v = p === "fixed" || p === "document" ? 1 : 0, g = p === "document" ? 1 : 0, y = t ? 1 : 0, w = t ? 0 : 1, C = o === "start" ? 1 : 0, E = o === "end" ? 1 : 0, $ = (i !== o ? 1 : 0) * a.width + c, F = C * a.left + E * (b - a.right - u), P = C * (b - a.right - u) + E * a.left, O = y * F + w * P, ee = C * window.scrollX - E * window.scrollX, te = E * window.scrollX - C * window.scrollX, ne = y * ee + w * te, Fe = Math.abs(Math.min(0, b - O - $ - n.width)), ue = v * O + $ + g * ne;
...
class ra {
  ...
  typeahead(e) {
    ...
    const t = this.lastActiveRecord ? this.lastActiveRecord[U.INDEX] : -1, o = this.typeaheadRecords.length, i = (p) => (p[U.INDEX] + o - t) % o, a = this.typeaheadRecords.filter((p) => !p[U.ITEM].disabled && p[U.TEXT].startsWith(this.typaheadBuffer)).sort((p, b) => i(p) - i(b));
    if (a.length === 0) {
...
class T extends f {
  ...
  renderSurface() {
    return l`
      <div
        ...
        style=${ge(this.menuPositionController.surfaceStyles)}
  ...
  async animateOpen() {
    ...
    const i = this.openCloseAnimationSignal.start(), a = e.offsetHeight, n = o === "UP", c = this.items, p = 500, b = 50, u = 250, v = (p - u) / c.length, g = e.animate([{ height: "0px" }, { height: `${a}px` }], {
      duration: p,
      easing: j.EMPHASIZED
    }), y = t.animate([
      { transform: n ? `translateY(-${a}px)` : "" },
      { transform: "" }
    ], { duration: p, easing: j.EMPHASIZED }), w = e.animate([{ opacity: 0 }, { opacity: 1 }], b), C = [];
    for (let $ = 0; $ < c.length; $++) {
      const F = n ? c.length - 1 - $ : $, P = c[F], O = P.animate([{ opacity: 0 }, { opacity: 1 }], {
        duration: u,
        delay: v * $
      });
      P.classList.toggle("md-menu-hidden", !0), O.addEventListener("finish", () => {
    ...
    return i.addEventListener("abort", () => {
      g.cancel(), y.cancel(), w.cancel(), C.forEach(([$, F]) => {
        $.classList.toggle("md-menu-hidden", !1), F.cancel();
      }), E(!0);
    }), g.addEventListener("finish", () => {
      e.classList.toggle("animating", !1), this.openCloseAnimationSignal.finish(), E(!1);
    }), await D;
  }
  /**
  ...
  animateClose() {
    ...
    const c = this.openCloseAnimationSignal.start(), p = o.offsetHeight, b = this.items, u = 150, v = 50, g = u - v, y = 50, w = 50, C = 0.35, E = (u - w - y) / b.length, D = o.animate([
      { height: `${p}px` },
      { height: `${p * C}px` }
    ], {
      duration: u,
      ...
      { transform: "" },
      {
        transform: n ? `translateY(-${p * (1 - C)}px)` : ""
      }
    ], { duration: u, easing: j.EMPHASIZED_ACCELERATE }), F = o.animate([{ opacity: 1 }, { opacity: 0 }], { duration: v, delay: g }), P = [];
    for (let O = 0; O < b.length; O++) {
      const ee = n ? O : b.length - 1 - O, te = b[ee], ne = te.animate([{ opacity: 1 }, { opacity: 0 }], {
        duration: y,
        delay: w + E * O
      });
    ...
    return c.addEventListener("abort", () => {
      D.cancel(), $.cancel(), F.cancel(), P.forEach(([O, ee]) => {
        ee.cancel(), O.classList.toggle("md-menu-hidden", !1);
      }), e(!1);
    }), D.addEventListener("finish", () => {
      o.classList.toggle("animating", !1), P.forEach(([O]) => {
  ...
  constructor(e, t) {
    this.host = e, this.internalTypeaheadText = null, this.onClick = () => {
      ...
      if (o.defaultPrevented)
        return;
      const i = o.code;
      this.host.keepOpen && i !== "Escape" || li(i) && (o.preventDefault(), this.host.dispatchEvent(Ro(this.host, {
        kind: Po.KEYDOWN,
        key: i
      })));
...
class hi extends f {
  ...
  handleKeyDown(e) {
    ...
    if (e.preventDefault(), i || a) {
      ...
      n[g].focus({ trailing: a }), this.updateTabIndices();
      return;
    }
    const p = getComputedStyle(this).direction === "rtl" ? t : o, b = n.find((g) => g.matches(":focus-within"));
    if (!b) {
...
const gi = /* @__PURE__ */ Symbol("animateIndicator"), Ia = Ta(f);
class K extends Ia {
  /**
  ...
  getKeyframes(e) {
    ...
    const o = {}, i = e.indicator?.getBoundingClientRect() ?? {}, a = i.left, n = i.width, c = this.indicator.getBoundingClientRect(), p = c.left, b = c.width, u = n / b;
...
class ye extends f {
  ...
  async scrollToTab(e) {
    ...
    const o = e.offsetLeft, i = e.offsetWidth, a = this.scrollLeft, n = this.offsetWidth, c = 48, p = o - c, b = o + i - n + c, u = Math.min(p, Math.max(b, a)), v = this.focusedTab ? "auto" : "instant";
  ...
  async handleKeydown(e) {
    ...
    if (i || a)
      ...
      if (!v)
        ...
        const g = this.tabs.indexOf(v);
        c = u ? g + 1 : g - 1, c >= n.length ? c = 0 : c < 0 && (c = n.length - 1);
      }
    }
    const p = n[c];
...
class I extends Na {
  ...
  async animateDialog(e) {
    ...
    if (!t || !o || !i || !a || !n || !c)
      return;
    const { container: p, dialog: b, scrim: u, headline: v, content: g, actions: y } = e, w = [
      [t, b ?? []],
      [o, u ?? []],
      [i, p ?? []],
      [a, v ?? []],
    ...
    await Promise.all(C.map((E) => E.finished.catch(() => {
    })));
  }
...
class wi extends xe {
  ...
  renderIndicator() {
    ...
    return l`
      ...
      <div class="inactive-track" style=${ge(a)}></div>
      <div class="bar primary-bar" style=${ge(e)}>
                ...
                <div class="group" role="group" aria-label="${o}">
                    ${[0, 1].map((a) => l`
                        <button
                            ...
                            @keydown="${(n) => this._handleKeyDown(n, a)}"
                        >
...
class ps extends f {
  ...
  _handleStepChange(e, t) {
    const { index: o, step: i } = t.detail, a = [...this.variations], n = a[e];
    n.steps && (n.steps[o] = i, this._notifyChange(a));
  }
...
This action cannot be undone.`;
    if (confirm(o)) {
      const i = this.variations.filter((a, n) => n !== e);
  ...
  _renderVariation(e, t) {
    const o = this._expandedIndex === t, i = t === 0, a = t === this.variations.length - 1, n = e.steps && e.steps.length > 0, c = e.template || !n, p = n ? "multi" : "single", b = (e.variables || []).map((u) => u.name);
    return l`
                            ...
                            ${n ? l`
                                ...
                                <div class="field-group">
                                    ...
                                    <div class="steps-section" @click="${(u) => u.stopPropagation()}">
                                        ${e.steps.map((u, v) => {
      const y = (this._expandedStepsByVariation[t] || []).includes(v);
      return l`
                                            <wy-step-editor
                                                .step="${u}"
                                                .index="${v}"
                                                ...
                                                .expanded="${y}"
                                                @step-change="${(w) => this._handleStepChange(t, w)}"
                                                @step-delete="${(w) => this._handleStepDelete(t, w)}"
                                                @step-move-up="${(w) => this._handleStepMoveUp(t, w)}"
                                                @step-move-down="${(w) => this._handleStepMoveDown(t, w)}"
                                                @step-toggle="${(w) => this._handleStepToggle(t, w)}"
                                            ></wy-step-editor>
                                        `;
    })}
                                        <button 
      ...
      return l`
        <div class="form-group">
          <wy-option-toggle
            ...
            @change="${(n) => this._handleInput(e.name, n.detail.value)}"
          ></wy-option-toggle>
        </div>
      `;
    }
...
customElements.define("wy-prompt-modal", bs);
class gs extends f {
  static properties = {
    open: { type: Boolean, reflect: !0 },
...
customElements.define("wy-allocation-card", Ts);
class Is extends f {
  static properties = {
    image: { type: String },
    category: { type: String },
...
customElements.define("wy-insight-card", Is);
class Ds extends f {
  static properties = {
    title: { type: String },
    artist: { type: String },
...
customElements.define("wy-work-card", Ds);
class Os extends f {
  static properties = {
    density: { type: String },
    // 'spacious', 'compact'
...
customElements.define("wy-works-grid", Os);
class Fs extends f {
  static properties = {
    title: { type: String },
...
customElements.define("wy-plot-card", Fs);
class Rs extends f {
  static properties = {
    status: { type: String },
