...
customElements.define("wy-logo", ds);
class cs extends b {
  static properties = {
    title: { type: String },
...
customElements.define("wy-app-bar", cs);
class ps extends b {
  static properties = {
...
customElements.define("wy-library-header", ps);
class hs extends b {
  static properties = {
    name: { type: String },
    role: { type: String },
...
customElements.define("wy-profile-card", hs);
class us extends b {
  static properties = {
    name: { type: String },
    role: { type: String },
...
customElements.define("wy-bio-card", us);
const fs = [
  {
    id: "p1",
...
class vs extends b {
  ...
  `;
  render() {
    const e = fs.filter((t) => t.category === this.filter);
    return n`
      <div>
...
customElements.define("wy-project-list", vs);
class ms extends b {
  static properties = {
    title: { type: String },
    value: { type: String },
...
customElements.define("wy-metric-card", ms);
class bs extends b {
  static properties = {
    title: { type: String },
    items: { type: Array }
...
customElements.define("wy-allocation-card", bs);
class gs extends b {
  static properties = {
    image: { type: String },
    category: { type: String },
...
customElements.define("wy-insight-card", gs);
class ys extends b {
  static properties = {
    title: { type: String },
    artist: { type: String },
...
customElements.define("wy-work-card", ys);
class xs extends b {
  static properties = {
    density: { type: String },
    // 'spacious', 'compact'
...
customElements.define("wy-works-grid", xs);
class _s extends b {
  static properties = {
    title: { type: String },
...
customElements.define("wy-plot-card", _s);
class ws extends b {
  static properties = {
    status: { type: String },
...
customElements.define("wy-backup-status", ws);
